            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Obx(()=> authController!.isProfileInformationLoading.value? Center(child: CircularProgressIndicator(),) :Container(
                    height: 50,
                    ...
                    child: elevatedButton(
                      ...
                      onpress: () async{
                        ...
                        authController!.uploadProfileData(imageUrl, nameController.text.trim(),
                            mobileNumberController.text.trim(), dob.text.trim(), selectedRadio ==0 ? "Male": "Female", uid);
